...
public class Petal extends TextureObject{
    ...
    static private final String[][] textureList = {{"shape_225", "shape_226", "shape_227", "shape_228", "shape_229", "shape_230",
            "shape_232", "shape_233", "shape_234", "shape_235", "shape_236", "shape_237", "shape_238", "shape_239",
            "shape_240", "shape_241"}};
    static private final float[][] pivotList = {{23.45f, 13.55f}, {24.75f, 8.9f}, {24.25f, 3.55f}, {23.5f, 8.65f}, {24.75f, 8.9f}, {25.55f, 15.8f},
            {24.05f, 12.1f}, {23.25f, 8.95f}, {15.25f, 20.75f}, {7.45f, 7.35f}, {13.2f, 17.85f}, {14.45f, 14.95f}, {14.45f, 6.7f}, {14.45f, 23.1f},
            {8.9f, 24.35f}, {16.75f, 18.9f}};
    private final float [][] startMatrixTransform = {
    ...
    private final float[][] startColorTransform = {{141, 141, 141, 256}, {106, 96, 13, 0}};
    ...
    private void creatorObjects() {
        ...
        for (int i = creatingFramesCounterSize-1; i>=0; i--) {
            ...
            creator._C++;
            switch (creator._C) {
                case 1: createObject(creator,0); break;
                case 4: createObject(creator,1); break;
                case 8: createObject(creator,2); break;
                case 14: createObject(creator,3); break;
            }
